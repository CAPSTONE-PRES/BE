...
class UserServiceTest {
    ...
    void updateUser() {
        ...
        assertThat(userService.getUser(user.getId()).getUsername()).isEqualTo("updated");
    }
    ...
    void listUsers() {
        userRepository.save(User.builder().email("a@email.com").password("pw").username("a").build());
        userRepository.save(User.builder().email("b@email.com").password("pw").username("b").build());
