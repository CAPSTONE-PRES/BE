...
@Entity
@Table(name = "cue_cards", uniqueConstraints = @UniqueConstraint(columnNames = { "file_id", "slide_number", "mode",
                "section_no_key" }), indexes = {
...
public class CueCard {
        ...
        @Column(name = "section_no_key", insertable = false, updatable = false, columnDefinition = "INT AS (IFNULL(section_number, 0)) STORED")
